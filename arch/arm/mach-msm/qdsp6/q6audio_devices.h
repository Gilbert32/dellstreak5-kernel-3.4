...
#define ACDB_ID_SPKR_LINEOUT 65
#define ACDB_ID_HANDSET_HAC 66
#define ACDB_ID_VR_MIC              67
#endif
...
static struct q6_device_info q6_audio_devices[] = {
	...
	},
	{
...
#ifdef CONFIG_HW_AUSTIN
        {
                .id     = ADSP_AUDIO_DEVICE_ID_NULL_SINK_FM_SPEAKER,
                .cad_id = CAD_HW_DEVICE_ID_SPEAKER_SPKR_STEREO_LB,
                .path   = ADIE_PATH_AUXPGA_LINEOUT_STEREO_LB,
                .rate   = 48000,
                .dir    = Q6_TX_RX,
                .codec  = Q6_ICODEC_RX,
                .hw     = Q6_HW_SPEAKER,
        ...
        {
                .id     = ADSP_AUDIO_DEVICE_ID_NULL_SINK_FM_HEADSET,
