...
static struct clk_lookup msm_clocks_8x50[] = {
	...
	CLK_LOOKUP("vdc_clk",		vdc_clk.c,	NULL),
	CLK_LOOKUP("vfe_clk",		vfe_clk.c,	NULL),
	CLK_LOOKUP("vfe_mdc_clk",	vfe_mdc_clk.c,	"msm_camera_ov7690.0"),
	CLK_LOOKUP("vfe_axi_clk",	vfe_axi_clk.c,	"msm_camera_ov7690.0"),
	CLK_LOOKUP("vfe_mdc_clk",	vfe_mdc_clk.c,	"msm_camera_ov5642"),
	CLK_LOOKUP("vfe_axi_clk",	vfe_axi_clk.c,	"msm_camera_ov5642"),
	CLK_LOOKUP("alt_core_clk",	usb_hs2_clk.c,	 "msm_hsusb_host.0"),
