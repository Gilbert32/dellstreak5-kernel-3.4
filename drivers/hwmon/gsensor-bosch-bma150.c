...
static int i2c_gsensor_suspend(struct device *dev);
static int i2c_gsensor_resume(struct device *dev);
...
static const struct dev_pm_ops bosch_bma150_dev_pm_ops = {
