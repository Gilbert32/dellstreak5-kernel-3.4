...
#define CFG_SET_SCENE               29
#define CFG_SET_IMAGE_QUALITY       30
#define CFG_SET_MULTI_SHOT          31
#define CFG_SET_AUTO_FOCUS          32
#define CFG_DUMP_SINGLE_REGISTER    33
#define CFG_DUMP_REGISTERS_TO_FILE  34
#define CFG_SET_SINGLE_REGISTER     35
#define CFG_SET_REGISTERS_FROM_FILE 36
...
#ifdef CONFIG_HW_AUSTIN
#define SENSOR_5M_SIZE          2
#define SENSOR_WALLPAPER_SIZE   3
#define SENSOR_QXGA_SIZE        4
#define SENSOR_UXGA_SIZE        5
#define SENSOR_SXGA_SIZE        6
#define SENSOR_VGA_SIZE         7
#define SENSOR_QVGA_SIZE        8
#define SENSOR_INVALID_SIZE     9
#else
...
#ifdef CONFIG_HW_AUSTIN
struct auto_focus_status {
    int32_t steps;
    uint32_t duration;
};
struct os_engineer_reg_cfg {
    uint16_t addr;
    uint16_t data;
};
struct os_engineer_file_cfg {
    uint16_t len;
    uint16_t addr;
    char     *buf;
};
...
#ifdef CONFIG_HW_AUSTIN
        struct auto_focus_status af_status;
        struct os_engineer_reg_cfg  single_reg;
        struct os_engineer_file_cfg burst_file;
#endif
